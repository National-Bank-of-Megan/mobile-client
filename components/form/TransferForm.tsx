...
import {isNotEmpty, isValidAccountNumber, isValidTransferAmount} from "../../common/validation";
        ...
        <>
            <View style={GlobalStyles.formView}>
                ...
                <BalanceAmountInput showDialog={showDialog}
                                    selectedCurrencySymbol={findCurrencySymbolByCurrencyName(subAccountBalanceList, selectedCurrencyName)}
                                    value={amountValue}
                                    onChangeText={amountChangeHandler}
                                    onBlur={amountBlurHandler}
                                    error={amountHasError}/>
                <View style={styles.balanceInfoContainer}>
                    <Text style={styles.balanceText}><>Currency balance after
            ...
            <Button mode='contained' onPress={makeTransferHandler} style={styles.transferButton}
                    labelStyle={GlobalStyles.buttonLabel}>TRANSFER MONEY</Button>
            <View>

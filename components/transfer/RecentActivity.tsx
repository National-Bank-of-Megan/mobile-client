...
import {Divider, Subheading, Text, useTheme, withTheme} from "react-native-paper";
        ...
        <View style={styles.container}>
            ...
            <View style={styles.recentActivityListContainer}>
                ...
                }
                {
                    ...
                    !!errorRecentActivity && <>
                        <Text style={[{color: Colors.SNACKBAR_FAILURE, textAlign: 'center'}]}>Could not download recent
                            activities.</Text>
                    </>
                }

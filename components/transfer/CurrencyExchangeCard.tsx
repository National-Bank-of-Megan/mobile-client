    ...
    return (
      <View style={recentActivityCardStyles.cardContainer}>
        <View style={recentActivityCardStyles.cardContent}>
          <View>
            <Text style={[recentActivityCardStyles.cardTitle, fonts.regular]}>{'+'+item.bought.toFixed(2)+' '+item.currencyBought}</Text>
          ...
          <View style={[recentActivityCardStyles.amountContainer]}>
            <Text style={recentActivityCardStyles.amount}>{'-'+item.sold.toFixed(2)+' '+item.currencySold}</Text>
          </View>
        </View>
      </View>
    );

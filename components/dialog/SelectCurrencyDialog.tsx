import {Dialog, RadioButton, Text} from "react-native-paper";
                ...
                <RadioButton.Group onValueChange={handleCurrencyChange} value={selectedCurrencyName}>
                    {subAccountBalanceList?.map((subAccountBalance) =>
                        <View key={subAccountBalance.currency} style={styles.row}>
                            <RadioButton color={Colors.PRIMARY} uncheckedColor={Colors.SECONDARY}
                                         value={subAccountBalance.currency}/>
                            <Text
                                style={styles.text}>{subAccountBalance.currency + ' - ' + subAccountBalance.balance + ' ' + subAccountBalance.symbol}</Text>
                        </View>
                    )}
                </RadioButton.Group>
            </Dialog.Content>

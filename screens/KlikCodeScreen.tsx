...
import {Button, Headline, ProgressBar, Text} from "react-native-paper";
...
const KlikCodeScreen = () => {
  return (
    <View style={GlobalStyles.container}>
      ...
      <KlikCode />
      <Button mode='contained' icon="content-copy" contentStyle={styles.copyButtonContent} style={styles.copyButton}
